    ...
    def setUpClass(cls) -> None:
        ...
        cls.assessment = build_assessment_record(
            ...
            requirement_results=[
                ...
                {
                    "requirement_id": "EAS-003-R02",
                    "applicability": applicability(),
                    "title": "Material assumptions and uncertainty",
                    "level": "MUST",
                    "result": "indeterminate",
                    "reason": "The available trace omits understanding events.",
                    "evidence_refs": [],
                    "validator_rule_refs": [],
                    "scenario_refs": ["SCN-001"],
                },
                {
                    "requirement_id": "EAS-006-R04",
                    "applicability": applicability(applicable=False),
                    "title": "Unavailable check reporting",
                    "level": "MUST",
                    "result": "not_applicable",
                    "reason": "No required check was unavailable.",
                    "evidence_refs": [],
                    "validator_rule_refs": [],
                    "scenario_refs": ["SCN-001"],
                },
