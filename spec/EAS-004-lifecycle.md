...
- **EAS-004-R04**: Discovery that invalidates understanding or planning MUST
  cause an appropriate backward transition before further dependent action.
- **EAS-004-R05**: Failed verification MUST lead to correction, replanning,
  escalation, blocking, or truthful reporting; it MUST NOT be silently ignored.
- **EAS-004-R06**: A completed outcome MUST end in `COMPLETED`; escalated and
  blocked outcomes MUST end in their corresponding states.
